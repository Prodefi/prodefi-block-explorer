...
import AvenirRegular from '../fonts/AvenirNext/TTF/SVN-Avenir-Next-Regular.ttf';
import AvenirMedium from '../fonts/AvenirNext/TTF/SVN-Avenir-Next-Medium.ttf';
import AvenirDemiBold from '../fonts/AvenirNext/TTF/SVN-Avenir-Next-DemiBold.ttf';
...
@font-face {
  ...
  src: url(${AvenirDemiBold}) format("truetype");
}
...
.icons8-wrench-outline:before { content: "\f108"; }
  ...
  .pagination li a {
    ...
    border: 0.5px solid rgba(107, 105, 105, 0.1);
  }
