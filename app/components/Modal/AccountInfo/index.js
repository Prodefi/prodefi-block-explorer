  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <Main>
          {!modalDataFetchingState && !!Object.keys(accountInfo).length && (
            <InfoContainer>
              <DataBlock>
              ...
              <DataBlock>
                <div>
                  <TextSpanBold>{t('i18nModal.i18nAccountInfo.ramUsed')}:</TextSpanBold> {accountInfo.ram_usage || '--'}{' '}
                  {t('i18nModal.i18nAccountInfo.bytes')} / {t('i18nModal.i18nAccountInfo.quota')}:{' '}
                  {accountInfo.total_resources.ram_bytes || '--'} {t('i18nModal.i18nAccountInfo.bytes')}
                </div>
              </DataBlock>
              <DataBlock>
                <div>
              ...
              <DataBlock>
                ...
                <div>
                  <TextSpanBold>{t('i18nModal.i18nAccountInfo.max')}:</TextSpanBold> {accountInfo.cpu_limit.max || '--'}{' '}
                  {t('i18nModal.i18nAccountInfo.time')}
                </div>
              </DataBlock>
